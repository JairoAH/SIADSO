...
%>
<%-- 
    Document   : IndexTecnico
    Created on : 28/02/2015, 05:18:05 PM
        ...
        <div class="container">
            ...
            <div class="mp-pusher" id="mp-pusher">
                ...
                <nav id="mp-menu" class="mp-menu">
                    <div class="mp-level">
                        <h2 class="icon icon-male">TECNICO:</br>
                            <%
            ...
            if (sesion.getAttribute("usuario") == null) {
                ...
                out.print(usuarioMostrar.getNombres() + " " + usuarioMostrar.getApellidos());
                        ...
                        <ul>
                            <li><a class="icon icon-display" href="#">Solicitud de servicio</a></li>
                            ...
                            <li><a class="icon icon-trash" href=".jsp" onclick="confirmar(this.href);
                                    return false">Cerrar Sesion</a></li>
                        </ul>
                ...
                <div class="scroller"><!-- this is for emulating position fixed of the nav -->
                    <div class="scroller-inner">
                        ...
                        <div class="content clearfix">
                            ...
                            <iframe  src="../../Registro equipo/RegistroEquipo.html" name="SubHtml"
